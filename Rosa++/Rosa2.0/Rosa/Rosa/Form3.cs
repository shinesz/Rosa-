    ...
    public partial class Rosa : Form
    {
        ...
        private void button1_Click(object sender, EventArgs e)
        {
            try
            {
                ...
                MySqlCommand query = new MySqlCommand("select* from Medico where usuario ='" + textBox1.Text + "' and senha ='" + textBox2.Text + "'", connection);
        ...
        private void Rosa_Load(object sender, EventArgs e)
        {
